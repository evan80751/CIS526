...
export async function up({ context: queryInterface }) {
    const metadataCommunities = csvToJson.fieldDelimiter(',').getJsonFromCsv('./data/metadata_communities.csv');
...
export async function down({ context: queryInterface }) {
    await queryInterface.bulkDelete('metadata_communities', {}, { truncate: true });
}