...
Metadata.belongsToMany(Document, { through: MetadataDocument, unique: false, as: 'documents'})
Document.belongsToMany(Metadata, {through: MetadataDocument, unique: false, as: 'metadata' })

Metadata.belongsToMany(Community, { through: MetadataCommunity, unique: false, as: 'communities' })
Community.belongsToMany(Metadata, { through: MetadataCommunity, unique: false, as: 'metadata' })
